...
{
	$arResult['values']['defaultValue']['attrName'] =
		HtmlFilter::encode($GLOBALS[$arResult['additionalParameters']['NAME']]['DEFAULT_VALUE']['attrName']);
	$arResult['values']['defaultValue']['attrValues'] =
		HtmlFilter::encode($GLOBALS[$arResult['additionalParameters']['NAME']]['DEFAULT_VALUE']['attrValues']);
	$arResult['values']['title']['attrName'] =
		HtmlFilter::encode($GLOBALS[$arResult['additionalParameters']['NAME']]['DEFAULT_VALUE']['TITLE']['attrName']);
	$arResult['values']['title']['attrValues'] =
		HtmlFilter::encode($GLOBALS[$arResult['additionalParameters']['NAME']]['DEFAULT_VALUE']['TITLE']['attrValues']);
...
{
	$arResult['values']['defaultValue']['attrName'] =
		HtmlFilter::encode($arResult['userField']['SETTINGS']['DEFAULT_VALUE']['attrName']);
	$arResult['values']['defaultValue']['attrValues'] =
		HtmlFilter::encode($arResult['userField']['SETTINGS']['DEFAULT_VALUE']['attrValues']);
	$arResult['values']['title']['attrName'] =
		HtmlFilter::encode($arResult['userField']['SETTINGS']['DEFAULT_VALUE']['TITLE']['attrName']);
	$arResult['values']['title']['attrValues'] =
		HtmlFilter::encode($arResult['userField']['SETTINGS']['DEFAULT_VALUE']['TITLE']['attrValues']);
	$arResult['values']['size'] =
