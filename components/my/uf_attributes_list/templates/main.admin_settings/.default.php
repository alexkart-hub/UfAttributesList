...
<tr>
    ...
    <td>
        <input
                type="text"
                name="<?= $additionalParameters['NAME'] ?>[DEFAULT_VALUE][TITLE][attrName]"
                size="20"
                maxlength="225"
                value="<?= $arResult['values']['title']['attrName'] ?>"
        >
        <input
                type="text"
                name="<?= $additionalParameters['NAME'] ?>[DEFAULT_VALUE][TITLE][attrValues]"
                size="20"
                maxlength="225"
                value="<?= $arResult['values']['title']['attrValues'] ?>"
        >
    </td>
</tr>
<tr>
    ...
    <td>
        <input
                type="text"
                name="<?= $additionalParameters['NAME'] ?>[DEFAULT_VALUE][attrName]"
                size="20"
                maxlength="225"
                value="<?= $arResult['values']['defaultValue']['attrName'] ?>"
        >
        <input
                type="text"
                name="<?= $additionalParameters['NAME'] ?>[DEFAULT_VALUE][attrValues]"
                size="20"
                maxlength="225"
                value="<?= $arResult['values']['defaultValue']['attrValues'] ?>"
        >
    </td>
</tr>
<!--<tr>-->
...
<!--	</td>-->
<!--</tr>-->
<? if (!empty($arResult['userField']['MULTIPLE']) && $arResult['userField']['MULTIPLE'] == 'Y') { ?>
    <tr>
